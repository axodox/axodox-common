...
{
  struct AXODOX_COMMON_API HuggingFaceModelInfo : public Json::json_object_base
  {
  ...
  struct AXODOX_COMMON_API HuggingFaceFileRef : public Json::json_object_base
  {
  ...
  struct AXODOX_COMMON_API HuggingFaceModelDetails : public Json::json_object_base
  {
